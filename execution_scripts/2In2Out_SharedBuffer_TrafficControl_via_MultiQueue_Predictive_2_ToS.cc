...
/*
 * Basic Topology: 
 * 2 groups of 2 client servers: t0 and t1, connected to 2 Rx ports: p0 and p1 (2 servers connected to each port), on a switch: S,
 * and 2 Tx ports: p0 and p1, connected to 2 receivers: r0 and r1, each.
...
int main (int argc, char *argv[])
{
  ...
  for (size_t i = 0; i < 2; i++)
  {
    ...
    sinkApps.Add(sinkPredictP0.Install (recieversPredict.Get(recieverIndex)));
    sinkApps.Add(sinkPredictP1.Install (recieversPredict.Get(recieverIndex)));
  }
