 ...
 */
#ifndef UDP_PRIO_CLIENT_SERVER_HELPER_H
#define UDP_PRIO_CLIENT_SERVER_HELPER_H
 ...
 *
 */
class UdpPrioClientHelper
{
  public:
    /**
     * Create UdpPrioClientHelper which will make life easier for people trying
    ...
    UdpPrioClientHelper(Address ip, uint16_t port);
    /**
     *  Create UdpPrioClientHelper which will make life easier for people trying
     * to set up simulations with udp-client-server. Use this variant with
    ...
    UdpPrioClientHelper(Address addr);
...
#endif /* UDP_PRIO_CLIENT_SERVER_HELPER_H */
