set terminal png
set output "./Trace_Plots/test_Alphas/TestStats/via_MultiQueues/5_ToS/FB_0.1_TestAccumulativeStatistics.png"
...
plot "./Trace_Plots/test_Alphas/TestStats/via_MultiQueues/5_ToS/0.1/FB_TestAccumulativeStatistics.dat" using 0:2:xticlabels(1) with linespoints title "Total Packets Dropped", \
     ...
     "./Trace_Plots/test_Alphas/TestStats/via_MultiQueues/5_ToS/0.1/FB_TestAccumulativeStatistics.dat" using 0:4:xticlabels(1) with linespoints title "Low Priority Packets Dropped", \
